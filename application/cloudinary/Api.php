 ...
 *
        ...
        public function delete_resources($public_ids, $options = array())
        {
            ...
            $type = Cloudinary::option_get($options, "type", "upload");
            $uri = array("resources", $resource_type, $type);
            $params = $this->prepare_delete_resource_params($options, array("public_ids" => $public_ids));
        ...
        public function delete_resources_by_prefix($prefix, $options = array())
        {
            ...
            $type = Cloudinary::option_get($options, "type", "upload");
            $uri = array("resources", $resource_type, $type);
            $params = $this->prepare_delete_resource_params($options, array("prefix" => $prefix));
        ...
        public function delete_all_resources($options = array())
        {
            ...
            $type = Cloudinary::option_get($options, "type", "upload");
            $uri = array("resources", $resource_type, $type);
            $params = $this->prepare_delete_resource_params($options, array("all" => true));
        ...
        public function delete_derived_by_transformation(
            ...
            $params = array_merge($params, $this->only($options, array("invalidate")));
        ...
        protected function prepare_streaming_profile_params($options)
        {
            ...
            if (isset($options['representations'])) {
                $array_map = array_map(
                    array("transformation" => Cloudinary::generate_transformation_string($representation)),
        ...
        {
            $filtered = $this->only($options, array("keep_original", "next_cursor", "invalidate"));
